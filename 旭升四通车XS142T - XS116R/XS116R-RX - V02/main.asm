...
;           --|2 GND   		XC1  9|--
;           --|3 VCC	 	PB2  8|-- 
;        LED--|4 PA5		PA2  7|--MOTOR_TX
;      LED_F--|5 PA4		PA3  6|--PEN
;              -------------	
...
;flag_2
	...
	;#define		LAST_SHOW_KEY_FLAG			flag_2,7
...
SHOW_KEY_FUNC:
	BTRSS	key_cmd1,5
	LGOTO	NO_HAVE_SHOW_KEY_FUNC
HAVE_SHOW_KEY_FUNC:
	BTRSC	LAST_SHOW_KEY_FLAG
	RET
	BSR		LAST_SHOW_KEY_FLAG
	
	MOVIA	0X40
	XORAR	FLAG_2,1		;DEMO_FLAG		flag_2,6
	RET
NO_HAVE_SHOW_KEY_FUNC:
	BCR		LAST_SHOW_KEY_FLAG
	RET
;--------------------------------------------------------------------------	
MOTO_FUNC_EXIT:
	RET
